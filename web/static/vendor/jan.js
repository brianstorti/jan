...
Elm.Jan.make = function (_elm) {
   ...
   var initialModel = {possibleWeapons: _U.list([createWeapon("Rock"),createWeapon("Paper"),createWeapon("Scissors")])
                      ,players: _U.list([])
                      ,resultMessage: ""
                      ,currentPlayer: ""};
   ...
   var weaponView = F2(function (address,weapon) {
      ...
      _U.list([A2($Html.a,
      _U.list([$Html$Attributes.$class("weapon-wrapper"),A2($Html$Events.onClick,chooseWeaponMailbox.address,$String.toLower(weapon.name))]),
      _U.list([A2($Html.i,_U.list([$Html$Attributes.$class(A2($Basics._op["++"],"weapon fa fa-5x ",iconClassName))]),_U.list([]))
              ,A2($Html.p,_U.list([$Html$Attributes.$class("weapon-label")]),_U.list([$Html.text(weapon.name)]))]))]));
   });
   var weaponsList = F2(function (address,model) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("row weapons")]),A2($List.map,weaponView(address),model.possibleWeapons));
   });
